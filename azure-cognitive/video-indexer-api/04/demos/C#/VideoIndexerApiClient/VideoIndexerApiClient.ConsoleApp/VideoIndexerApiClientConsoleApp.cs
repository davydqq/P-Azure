...
namespace VideoIndexerApiClient.ConsoleApp
{
    class VideoIndexerApiClientConsoleApp
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Module 2 - Demo: Video Indexer Features

            //UploadBatchVids(@"SAMPLE VIDEO FOLDER");

            //SearchAsync("media").Wait();

            //SearchAsync("Microsoft Azure").Wait();

            //SearchAsync("outdoor").Wait();

            //SearchAsync("boy").Wait();

            //SearchFaceAsync("Scott Guthrie").Wait();

            


            // Module 3 - Demo: Authenticating with the Video Indexer API using C#
            ...
            // Module 4 - Demo: Indexing Content using C#
            ...
            // Module 5 - Demo: Searching Content using C#
            //SearchAsync("microsoft azure").Wait();




            // Module 5 - Demo: Playing Content using C#
            ...
            // Module 6 - Demo: Managing Transcripts using C#
            //DownloadVideoCaptions(MediaAssetId, @"FOLDER_PATH\file.vtt").Wait();
            //UpdateVideoTranscript(MediaAssetId, @"FOLDER_PATH\file.vtt").Wait();




            // Module 6 - Demo: Face Detection using C#
